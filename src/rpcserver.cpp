...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* RECO features */
        {"reco", "masternode", &masternode, true, true, false},
        {"reco", "listmasternodes", &listmasternodes, true, true, false},
        {"reco", "getmasternodecount", &getmasternodecount, true, true, false},
        {"reco", "masternodeconnect", &masternodeconnect, true, true, false},
        {"reco", "masternodecurrent", &masternodecurrent, true, true, false},
        {"reco", "masternodedebug", &masternodedebug, true, true, false},
        {"reco", "startmasternode", &startmasternode, true, true, false},
        {"reco", "createmasternodekey", &createmasternodekey, true, true, false},
        {"reco", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"reco", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"reco", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"reco", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"reco", "getmasternodescores", &getmasternodescores, true, true, false},
        {"reco", "mnbudget", &mnbudget, true, true, false},
        {"reco", "preparebudget", &preparebudget, true, true, false},
        {"reco", "submitbudget", &submitbudget, true, true, false},
        {"reco", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"reco", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"reco", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"reco", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"reco", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"reco", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"reco", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"reco", "checkbudgets", &checkbudgets, true, true, false},
        {"reco", "mnsync", &mnsync, true, true, false},
        {"reco", "spork", &spork, true, true, false},
        {"reco", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"reco", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use recod, or the -server option to reco-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"RECO Alert\" admin@foo.com\n"),
...
{
    return "> reco-cli " + methodname + " " + args + "\n";
}
