...
#if defined(NDEBUG)
#error "RECO cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 1 * COIN;
    } else if (nHeight <= 8000 && nHeight > Params().LAST_POW_BLOCK()) {
        nSubsidy = 4 * COIN;
    } else if (nHeight <= 14000 && nHeight >= 8001) {
        nSubsidy = 8 * COIN;
    } else if (nHeight <= 18000 && nHeight >= 14001) {
        nSubsidy = 32 * COIN;
    } else if (nHeight <= 30000 && nHeight >= 18001) {
        nSubsidy = 40 * COIN;
    } else if (nHeight <= 50000 && nHeight >= 30001) {
        nSubsidy = 60 * COIN;
    } else if (nHeight <= 90000 && nHeight >= 50001) {
        nSubsidy = 40 * COIN;
    } else if (nHeight <= 200000 && nHeight >= 90001) {
        nSubsidy = 32 * COIN;
        ...
        nSubsidy = (4.0 / pow(2, (nHeight - 400000) / 262800)) * COIN;
    } else {
        nSubsidy = 0 * COIN;
    }
    return nSubsidy;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (nHeight <= 8000 && nHeight > Params().LAST_POW_BLOCK()) {
        ret = 3 * COIN;
    } else if (nHeight <= 14000 && nHeight >= 8001) {
        ret = 6 * COIN;
    } else if (nHeight <= 18000 && nHeight >= 14001) {
        ...
        ret = (3.0 / pow(2, (nHeight - 400000) / 262800)) * COIN;
    } else {
        ret = 0 * COIN;
    }
