...
//! These need to be macros, as clientversion.cpp's and reco*-res.rc's voodoo requires it
...
/**
 * recod-res.rc includes this file, but it cannot cope with real c++ code.
