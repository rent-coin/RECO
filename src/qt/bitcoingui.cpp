                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("RECO Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a RECO address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and reco: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About RECO Core"), this);
    aboutAction->setStatusTip(tr("Show information about RECO Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for RECO"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your RECO addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified RECO addresses"));
    ...
    openAction->setStatusTip(tr("Open a RECO: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RECO Core help message to get a list with possible RECO command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("RECO Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to RECO network", "", count));
}
...
{
    QString strTitle = tr("RECO Core"); // default title
