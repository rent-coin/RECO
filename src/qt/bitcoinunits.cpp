...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(RECO);
    unitlist.append(mRECO);
    unitlist.append(uRECO);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case RECO:
        return QString("reco");
    case mRECO:
        return QString("mreco");
    case uRECO:
        return QString::fromUtf8("ureco");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case RECO:
            return QString("RECO");
        case mRECO:
            return QString("Milli-RECO (1 / 1" THIN_SP_UTF8 "000)");
        case uRECO:
            return QString("Micro-RECO (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
