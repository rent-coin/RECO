...
In order to support loading of multiple wallets in reco-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is reco.cpp.
...
Changes to reco.cpp
----------------------
reco.cpp is the entry point into reco-qt, and as such, will require some minor modifications to provide hooks for
